...
export type UsernamePasswordCred = Credential & {
    json: UsernamePasswordCredJson;
};

export function createUsernamePasswordCredential(
    title: string,
    password: string,
) {
...
export async function loginUsernamePassword(
    credentials: UsernamePasswordCred[],
    password: string,
) {
